                ...
                h_flex()
                    ...
                    .child(
                        div()
                            ...
                            .child(t!("ColorPicker.Hue").into_owned()),
                    )
                    .child(
                        div()
                            .relative()
                ...
                h_flex()
                    ...
                    .child(
                        div()
                            ...
                            .text_xs()
                            .text_color(label_color)
                            .child(t!("ColorPicker.Saturation").into_owned()),
                    )
                    .child(
                        div()
                            .relative()
                ...
                h_flex()
                    ...
                    .child(
                        div()
                            ...
                            .text_xs()
                            .text_color(label_color)
                            .child(t!("ColorPicker.Lightness").into_owned()),
                    )
                    .child(
                        div()
                            .relative()
                ...
                h_flex()
                    ...
                    .child(
                        div()
                            ...
                            .text_xs()
                            .text_color(label_color)
                            .child(t!("ColorPicker.Alpha").into_owned()),
                    )
                    .child(
                        div()
                            .relative()
