...
#[async_trait]
// COMMENTED OUT: impl<T: IdentityKeyStore + Send + Sync> IdentityKeyStore for Arc<RwLock<T>> {
    async fn get_identity_key_pair(
        &self,
    ) -> Result<IdentityKeyPair, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: PreKeyStore + Send + Sync> PreKeyStore for Arc<RwLock<T>> {
    async fn load_prekey(
        &self,
        prekey_id: u32,
    ) -> Result<Option<PreKeyRecordStructure>, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: SignedPreKeyStore + Send + Sync> SignedPreKeyStore for Arc<RwLock<T>> {
    async fn load_signed_prekey(
        &self,
        signed_prekey_id: u32,
    ) -> Result<Option<SignedPreKeyRecordStructure>, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: SessionStore + Send + Sync> SessionStore for Arc<RwLock<T>> {
    async fn load_session(
        // Reverted name
        &self,
        address: &SignalAddress,
...
#[async_trait]
// COMMENTED OUT: impl<T: SenderKeyStore + Send + Sync> SenderKeyStore for Arc<RwLock<T>> {
    async fn store_sender_key(
        &self,
        sender_key_name: &SenderKeyName,
        record: SenderKeyRecord,
...
#[async_trait]
// COMMENTED OUT: impl<T: IdentityKeyStore + Send + Sync> IdentityKeyStore for Arc<T> {
    async fn get_identity_key_pair(
        &self,
    ) -> Result<IdentityKeyPair, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: PreKeyStore + Send + Sync> PreKeyStore for Arc<T> {
    async fn load_prekey(
        &self,
        prekey_id: u32,
    ) -> Result<Option<PreKeyRecordStructure>, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: SignedPreKeyStore + Send + Sync> SignedPreKeyStore for Arc<T> {
    async fn load_signed_prekey(
        &self,
        signed_prekey_id: u32,
    ) -> Result<Option<SignedPreKeyRecordStructure>, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: SessionStore + Send + Sync> SessionStore for Arc<T> {
    async fn load_session(
        // Reverted name
        &self,
        address: &SignalAddress,
...
#[async_trait]
// COMMENTED OUT: impl<T: SenderKeyStore + Send + Sync> SenderKeyStore for Arc<T> {
    async fn store_sender_key(
        &self,
        sender_key_name: &SenderKeyName,
        record: SenderKeyRecord,
...
#[async_trait]
// COMMENTED OUT: impl<T: IdentityKeyStore + Send + Sync> IdentityKeyStore for Arc<Mutex<T>> {
    async fn get_identity_key_pair(
        &self,
    ) -> Result<IdentityKeyPair, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: PreKeyStore + Send + Sync> PreKeyStore for Arc<Mutex<T>> {
    async fn load_prekey(
        &self,
        prekey_id: u32,
    ) -> Result<Option<PreKeyRecordStructure>, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: SignedPreKeyStore + Send + Sync> SignedPreKeyStore for Arc<Mutex<T>> {
    async fn load_signed_prekey(
        &self,
        signed_prekey_id: u32,
    ) -> Result<Option<SignedPreKeyRecordStructure>, Box<dyn std::error::Error + Send + Sync>> {
...
#[async_trait]
// COMMENTED OUT: impl<T: SessionStore + Send + Sync> SessionStore for Arc<Mutex<T>> {
    async fn load_session(
        // Reverted name
        &self,
        address: &SignalAddress,
...
#[async_trait]
// COMMENTED OUT: impl<T: SenderKeyStore + Send + Sync> SenderKeyStore for Arc<Mutex<T>> {
    async fn store_sender_key(
        &self,
        sender_key_name: &SenderKeyName,
        record: SenderKeyRecord,
