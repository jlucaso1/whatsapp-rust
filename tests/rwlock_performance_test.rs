...
mod tests {
    ...
    async fn test_concurrent_device_snapshot_reads() {
        ...
        let persistence_manager = Arc::new(
            PersistenceManager::new_in_memory().await.unwrap()
        );
        ...
        println!("RwLock: {} concurrent readers × {} reads completed in {:?}", 
        ...
        assert!(elapsed.as_millis() < 5000, "Test should complete within reasonable time");
    }
    ...
    async fn test_read_write_contention() {
        ...
        let writer_handle = tokio::spawn(async move {
            ...
            pm_writer.modify_device(|device| {
        ...
        assert!(read_count > 10, "Should achieve substantial concurrent reads: {}", read_count);
    }
}